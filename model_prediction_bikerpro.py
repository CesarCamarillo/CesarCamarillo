...
#Las variables "seasons" ,"functioning_day" "holiday", "flag_day_weekend", "month_day" y "weekday" serán transformadas por OneHotEncoder
categorical_pipeline = Pipeline([('categorical', OneHotEncoder(handle_unknown='ignore'))])


#La variable "hour" será transformada por OrdinalEncoder
ordinal_pipeline = Pipeline([('ordinal', OrdinalEncoder())])


#nuestras variables "functioning_day","holiday" y "flag_day_weekend" serán transformadas a binarios, solo que lo haremos directamente desde la base de datos
binary_cols=["functioning_day", "holiday" ,"flag_day_weekend"]
...
params_rf = {}
params_rf['model__n_estimators']=[4,5,6,7,10]
params_rf['model__max_features'] = ["auto", "sqrt", "log2"]
params_rf['model__min_samples_split']=[4,5,6,7,10]
params_rf['model__bootstrap'] = [True, False]
params_rf['model__max_depth']=[3,5,10]
